...
public class StudentOrderDaoImplTest
{
    ...
    public StudentOrder buildStudentOrder(long id) {
        ...
        // Муж
        Adult husband = new Adult("Doe", "John", "Jamesson", LocalDate.of(1995, 3, 18));
        ...
        // Жена
        Adult wife = new Adult("Doe", "Jane", "Peterson", LocalDate.of(1997, 8, 21));
        ...
        // Ребенок
        Child child1 = new Child("Doe", "Eugenia", "Johnson", LocalDate.of(2016, 1, 11));
        ...
        // Ребенок
        Child child2 = new Child("Doe", "Alexander", "Johnson", LocalDate.of(2018, 10, 24));
